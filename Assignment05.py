...
# July 2025
# Omar Torres
# Assignment 05 – Menu-Based Webpage
...
<div class="topnav">
  ...
  <a data-tab="news" href="#news">News</a>
...
with open("Assignment05.html", "w") as file:
    file.write(html_content)

webbrowser.open(f"file://{os.path.abspath('Assignment05.html')}")
